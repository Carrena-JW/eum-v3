...
// ------------------------------------------------
mock.onGet('/apps/case-calendar/events').reply(config => {
...
// POST: Add new event
// ------------------------------------------------
mock.onPost('/apps/case-calendar/events').reply(config => {
...
// POST: Update Event
// ------------------------------------------------
mock.onPost(/\/apps\/case-calendar\/events\/\d+/).reply(config => {
